...
|---|---|---|
| Conversations | The basic chat | [Your first real conversation](../01-foundations/01-your-first-conversation.md) |
| Artifacts | Live, rendered output — code, HTML, docs, diagrams | [Artifacts and file creation](../01-foundations/05-artifacts-and-file-creation.md) |
| File upload | PDFs, images, spreadsheets, code | [Files, images, and vision](../01-foundations/04-files-and-vision.md) |
| File creation | Real .docx, .xlsx, .pptx, .pdf outputs | [Artifacts and file creation](../01-foundations/05-artifacts-and-file-creation.md) |
| Web search & Research | Live lookups; Research runs a multi-step investigation | [Web search and Research](../01-foundations/06-search-and-research.md) |
| Memory & personalisation | Claude remembers preferences across chats | [Memory and personalisation](../01-foundations/07-memory-and-personalisation.md) |
| Projects | A workspace with its own knowledge base and instructions | [Projects](../02-power-user/01-projects.md) |
| Skills | Custom, reusable capabilities | [Skills](../02-power-user/02-skills.md) |
| Connectors | MCP integrations to Gmail, Drive, Slack, Jira, etc. | [Connectors and MCP, explained without code](../02-power-user/03-connectors-and-mcp.md) |
| Claude Design | A canvas for design work | [Claude inside your apps](../02-power-user/05-claude-in-your-apps.md) |
| Incognito chats | Conversations that don't persist | [Memory and personalisation](../01-foundations/07-memory-and-personalisation.md) |
...
Covered in [Cowork](../02-power-user/04-cowork.md).
...
Covered in [Claude inside your apps](../02-power-user/05-claude-in-your-apps.md).
...
Covered in [The Claude Agent SDK](../05-agents/02-agent-sdk.md).
...
Covered in [Managed Agents](../05-agents/05-managed-agents.md).

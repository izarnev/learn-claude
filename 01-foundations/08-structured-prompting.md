...
Now this is a reusable asset. Fill it in by hand in chat, or programmatically in code. Once you have three or four of these, you have a prompt library — and that's exactly the thing that becomes a **Skill** in [Skills](../02-power-user/02-skills.md).

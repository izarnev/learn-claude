...
Cowork has its own project concept: workspaces that group related tasks with their own files, links, instructions, and **memory**. Notably, memory in Cowork is currently supported *in projects only*. See [Cowork](04-cowork.md).

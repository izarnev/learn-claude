...
Take the best template from your prompt library ([Structured prompting with XML](../01-foundations/08-structured-prompting.md)). Write it as a SKILL.md with proper frontmatter. Zip the folder. Upload it. Use it.

...
For developers, the related tool is the **security-guidance plugin** for Claude Code, which has Claude review its own code changes for vulnerabilities and fix them in the same session — covered in [Plugins and marketplaces](../03-claude-code/10-plugins-and-marketplaces.md).

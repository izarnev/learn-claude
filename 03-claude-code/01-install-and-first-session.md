---
title: "Install and first session"
order: 1
---
...
Start in `default`. Move to `acceptEdits` once you trust it on a given repo. Use `plan` for anything you want to review before it happens. Covered in depth in [Permissions, sandboxing, and safety](04-permissions-and-safety.md).

---
title: "Context and cost management"
order: 11
---
...
A subagent's forty file reads stay in *its* context. Only the summary comes back. See [Subagents, teams, and parallelism](07-subagents-and-parallelism.md).

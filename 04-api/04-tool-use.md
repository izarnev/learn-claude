...
Tool definitions are a stable prefix — cache them. See [Tool use with prompt caching](https://platform.claude.com/docs/en/agents-and-tools/tool-use/tool-use-with-prompt-caching) and [Prompt caching](07-prompt-caching.md).

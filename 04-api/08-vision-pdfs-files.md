---
title: "Vision, PDFs, and the Files API"
order: 8
---
...
The same technique from [Prompting fundamentals](../01-foundations/02-prompting-fundamentals.md), now in code:
...
Extract data from a chart image into a structured output ([Structured outputs](06-structured-outputs.md)). Verify against the axes yourself.

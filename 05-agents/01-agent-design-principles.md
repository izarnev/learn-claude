...
You cannot debug what you can't see. Log every turn: the prompt, the tools called, the results, the tokens, the decision. Covered in [Observability](../06-production/04-observability.md).

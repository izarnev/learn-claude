...
For any stable prefix over ~2k tokens used repeatedly. See [Prompt caching](../04-api/07-prompt-caching.md).
...
For agents: subagents for isolation, context editing to drop stale tool results, state files instead of compaction. See [Context engineering](../05-agents/03-context-engineering.md).
